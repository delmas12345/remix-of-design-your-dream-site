      ...
      background: "var(--gradient-hero)"
        ...
        <div className="relative container max-w-5xl mx-auto px-4 py-20 md:py-28">
          <div className="text-center text-primary-foreground">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto opacity-0 animate-fade-in mb-10" style={{
            ...
            {/* Feature pills */}
            <div className="flex flex-wrap justify-center gap-3 opacity-0 animate-fade-in" style={{
